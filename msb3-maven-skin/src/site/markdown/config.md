...
Msb3 skin supports extensive configuration options, including theme, layout, new/updated
...
using the `<custom><msb3Skin>` element.
...
-   **[Layouts]( layouts.html )**
    ...
    Msb3 the page with different layouts: multi-column text, carousel, thumbnails and others.
...
Msb3 skin has quite a number of configuration options, which can be applied either globally or
